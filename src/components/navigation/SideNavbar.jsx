...
const SideNavbar = ({ isCollapsed, onToggle }) => {
    ...
    const menuItems = [
        ...
        { icon: faCalendar, label: t('CALENDAR'), link: '/calendar', isVisible: userHasRole(roleConstant.superAdministrator) || userHasRole(roleConstant.administrator) || userHasRole(roleConstant.employee) },
